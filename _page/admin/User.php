                    ...
                    <div class="tab-pane fade show active" id="tabs1" role="tabpanel" aria-labelledby="tab1">
                        <table class="table align-middle mb-0 bg-white">
                            ...
                            <tbody>
                                <?php 
                                $db1 = new database();
                                $db1 -> select("users,dept","*","status_user = 1 AND type_user = 1 AND dept_user = id_dept");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="fw-normal mb-1">
                                            <?=($personactive -> name_dept != '') ?  $personactive -> name_dept : "Not Selected" ?>
                                        </p>
                                    </td>
                        ...
                        <table class="table align-middle mb-0 bg-white">
                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="fw-normal mb-1">
                                            <?=($personwait -> name_dept != '') ?  $personwait -> name_dept : "Not Selected" ?>
                                        </p>
                                    </td>
                    ...
                    <div class="tab-pane fade" id="tabs3" role="tabpanel" aria-labelledby="tab3">
                        <table class="table align-middle mb-0 bg-white">
                            ...
                            <tbody>
                                <?php 
                                $db1 = new database();
                                $db1 -> select("users,dept","*","status_user = 3 AND type_user = 1 AND dept_user = id_dept");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="fw-normal mb-1">
                                            <?=($personnoactive -> name_dept != '') ?  $personnoactive -> name_dept : "Not Selected" ?>
                                        </p>
                                    </td>
